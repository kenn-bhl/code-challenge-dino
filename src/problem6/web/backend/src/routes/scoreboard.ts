...
import { fail, ok, type MissionCompleteInput } from "../types.js";
 ...
 */
async function handleGetLeaderboard(req: Request, res: Response): Promise<void> {
 ...
 */
async function handleStartMission(_req: Request, res: Response): Promise<void> {
 ...
 */
async function handleCompleteMission(req: Request, res: Response): Promise<void> {
  const body = req.body as Partial<MissionCompleteInput>;
 ...
 */
async function handleCompleteAction(req: Request, res: Response): Promise<void> {
  const body = req.body as Partial<MissionCompleteInput>;
  if (!body.actionId || typeof body.actionId !== "string") {
 ...
 */
function handleLeaderboardStream(_req: Request, res: Response): void {
